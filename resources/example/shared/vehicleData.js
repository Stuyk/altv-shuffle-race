export const VehicleData = [
    ...
    },
    {
        ...
        model: 'jb7002',
        hash: 394110044,
        class: { id: 5, name: 'Sports Classics' },
        seats: 2,
        maxPassengers: 1,
        inDealership: false,
...
export const VehicleDataClasses = [
    { id: 0, name: 'Compacts' },
    { id: 1, name: 'Sedans' },
    { id: 2, name: 'SUVs' },
    { id: 3, name: 'Coupes' },
...
export const VALID_VEHICLES_LIST = VehicleData.filter(vehicle => {
    const className = vehicle.class.name;

    if (VALID_VEHICLE_MODELS.includes(className)) {
        return vehicle;
    }
});